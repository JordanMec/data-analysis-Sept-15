...
% ANALYZE_FILTER_PERFORMANCE Compare HEPA vs MERV with uncertainty bounds
...
for i = 1:height(uniqueConditions)
    ...
    % Get HEPA data for both envelope conditions
    hepaTight = compRows(strcmp(compRows.location, loc) & ...
        strcmp(compRows.mode, mode) & ...
        strcmpi(compRows.filterType, 'hepa') & ...
    ...
    % Get MERV data for both envelope conditions
    mervTight = compRows(strcmp(compRows.location, loc) & ...
        strcmp(compRows.mode, mode) & ...
        strcmpi(compRows.filterType, 'merv') & ...
        strcmp(compRows.leakage, 'tight'), :);
    ...
    % Calculate bounds for HEPA performance
    ...
    % Calculate bounds for MERV performance
